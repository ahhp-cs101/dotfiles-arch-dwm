...
run "xrandr --output eDP1 --mode 1366x768 --pos 0x0 --rotate normal --output DP1 --primary --mode 1280x1024 --pos 1366x0 --rotate normal --output HDMI1 --off --output HDMI2 --off --output VIRTUAL1 --off"
...
run "setxkbmap -model pc104 -layout us,ar -option grp:alt_shift_toggle"
run "nm-applet"
run "pamac-tray"
# run "variety"
...
feh --bg-fill $HOME/Pictures/Wallpaper_2.jpg &
